...
The successful response schema is a JSON object with exactly these fields: id is a string containing the decimal identifier, sku is a string, and qty is an integer.
