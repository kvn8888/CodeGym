      ...
      render={
        render ?? (
          <Button
            ...
            className={size === 'icon-sm' ? 'size-8 rounded-full' : undefined}
          />
        )
      }
      {...props}
...
/* eslint-disable react-refresh/only-export-components -- re-export hooks with components (shadcn pattern) */
export {
